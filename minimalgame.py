'''
A small example following details at http://bridgesuncc.github.io/tutorials/NonBlockingGame.html
...
class MinimalGame (NonBlockingGame):
    def	__init__(self, assid, user_id, api_key):
        # substitute your assignment number, username and api key
		# create a game board of 10x10
        super().__init__(3, BRIDGES_USERNAME,  BRIDGES_API_KEY, 10, 10)
...
def	main():
	game = MinimalGame(3, BRIDGES_USERNAME,  BRIDGES_API_KEY,)
	# start the game
	game.start()
